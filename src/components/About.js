...
const About = () => (
  <section className="px-8 py-12 pb-12 md:p-14 lg:p-24 text-slate-300" id="about">
    ...
    <div className="grid grid-cols-12 gap-3">
      <div className="opacity-5 md:opacity-100 col-[_1/_-1] md:col-[_1/_7] row-[_1/_-1] w-full h-full flex md:items-center">
      ...
      <div className="col-[_1/_-1] md:col-[_7/_-1] row-[_1/_-1] p-3 h-full">
        <div className="flex flex-col gap-5 h-full justify-center md:justify-start">
          <div>
            <h2 className="text-2xl text-center md:text-start">Self-taught Full Stack Developer</h2>
          </div>
